...
def train_and_evaluate(model, train_loader, val_loader, epochs, device, patience=5, output_dir=r"/cluster/projects/kite/LindsayS/metrics_directory_vgg16", csv_filename=r"/cluster/projects/kite/LindsayS/epoch_metrics.csv"):
...
def cross_validate_and_grid_search(data_dir, param_grid, device, output_dir=r"/cluster/projects/kite/LindsayS/metrics_directory_vgg16"): #"/cluster/projects/kite/LindsayS/metrics_directory"
...
if __name__ == "__main__":
    ...
    output_dir=r"/cluster/projects/kite/LindsayS/metrics_directory_vgg16"
