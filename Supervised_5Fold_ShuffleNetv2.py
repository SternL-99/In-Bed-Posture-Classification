...
def build_model(num_classes, num_layers, units_per_layer, dropout_rate, input_size=224):
    model = models.shufflenet_v2_x1_0(pretrained=False)  # Load ShuffleNet V2 (1.0x) without pre-trained weights
...
def train_and_evaluate(model, train_loader, val_loader, epochs, device, patience=5, output_dir=r"/cluster/projects/kite/LindsayS/metrics_directory_shuffle", csv_filename='epoch_metrics.csv'):
...
def cross_validate_and_grid_search(data_dir, param_grid, device, output_dir=r"/cluster/projects/kite/LindsayS/metrics_directory_shuffle"): #"/cluster/projects/kite/LindsayS/metrics_directory"
...
if __name__ == "__main__":
    ...
    output_dir=r"/cluster/projects/kite/LindsayS/metrics_directory_shuffle"
