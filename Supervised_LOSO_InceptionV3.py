...
def train_and_evaluate(model, train_loader, val_loader, epochs, device, patience=5, output_dir=r"/cluster/projects/kite/LindsayS/InceptionV3_LOSO/metrics_directory", csv_filename=r"/cluster/projects/kite/LindsayS/InceptionV3_LOSO/epoch_metrics.csv"):
...
if __name__ == "__main__":
    ...
    output_dirs = {
    "models": r"/cluster/projects/kite/LindsayS/InceptionV3_LOSO/models",
    "training_plots": r"/cluster/projects/kite/LindsayS/InceptionV3_LOSO/training_plots",
    "confusion_matrices": r"/cluster/projects/kite/LindsayS/InceptionV3_LOSO/confusion_matrices",
    "logs": r"/cluster/projects/kite/LindsayS/InceptionV3_LOSO/logs",
    "results": r"/cluster/projects/kite/LindsayS/InceptionV3_LOSO/analysis_outputs"
    }
