...
# Step 2: Define the VGG16 model with tunable hyperparameters
def build_model(num_classes, num_layers, units_per_layer, dropout_rate, input_size=224):
    ...
    weights_path = r'/cluster/projects/kite/LindsayS/vgg16_weights.pth'  # Path to the weights file
    ...
    classifier_layers = []
    in_features = model.classifier[0].in_features  # Input size of the first FC layer in VGG16
    ...
    for _ in range(num_layers - 1):  # Skip the first one as it's already added
    ...
    # Replace the classifier in VGG16
...
def train_and_evaluate(model, train_loader, val_loader, epochs, device, patience=5, output_dir=r"/cluster/projects/kite/LindsayS/VGG_LOSO/metrics_directory", csv_filename=r"/cluster/projects/kite/LindsayS/VGG_LOSO/epoch_metrics.csv"):
...
if __name__ == "__main__":
    ...
    output_dirs = {
    "models": r"/cluster/projects/kite/LindsayS/VGG_LOSO/models",
    "training_plots": r"/cluster/projects/kite/LindsayS/VGG_LOSO/training_plots",
    "confusion_matrices": r"/cluster/projects/kite/LindsayS/VGG_LOSO/confusion_matrices",
    "logs": r"/cluster/projects/kite/LindsayS/VGG_LOSO/logs",
    "results": r"/cluster/projects/kite/LindsayS/VGG_LOSO/analysis_outputs"
    }
