...
# Step 2: Define the ShuffleNet v2 model with tunable hyperparameters
def build_model(num_classes, num_layers, units_per_layer, dropout_rate, input_size=224):
    model = models.shufflenet_v2_x1_0(pretrained=True)  # Load ShuffleNet V2 (1.0x) without pre-trained weights

    #when running on HPC4Health -- include step 2 and 3
    # Step 2: Load the weights from a file
    #weights_path = r'/cluster/projects/kite/LindsayS/shufflenet_v2_weights.pth'  # Path to the weights file
...
def train_and_evaluate(model, train_loader, val_loader, epochs, device, patience=5, output_dir=r"C:\Users\SternL\Desktop\Python_Data_Analysis\metrics_directory", csv_filename='epoch_metrics.csv'):
...
if __name__ == "__main__":
    data_dir = r"C:\Users\SternL\Desktop\Python_Data_Analysis\Classes_Sub"  # Replace with your dataset path
    ...
    output_dirs = {
    "models": r"C:\Users\SternL\Desktop\Python_Data_Analysis\models",
    "training_plots": r"C:\Users\SternL\Desktop\Python_Data_Analysis\training_plots",
    "confusion_matrices": r"C:\Users\SternL\Desktop\Python_Data_Analysis\confusion_matrices",
    "logs": r"C:\Users\SternL\Desktop\Python_Data_Analysis\logs",
    "results": r"C:\Users\SternL\Desktop\Python_Data_Analysis\analysis_outputs"
    }
